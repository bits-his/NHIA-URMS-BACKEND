...
const AdhocAssignmentReport = sequelize.define("AdhocAssignmentReport", {
...
}, { tableName: "adhoc_assignment_reports", modelName: "AdhocAssignmentReport" });

module.exports = AdhocAssignmentReport;
