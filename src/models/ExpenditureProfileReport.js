...
const ExpenditureProfileReport = sequelize.define("ExpenditureProfileReport", {
...
}, { tableName: "expenditure_profile_reports", modelName: "ExpenditureProfileReport" });

module.exports = ExpenditureProfileReport;
