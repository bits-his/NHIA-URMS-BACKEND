...
const SshiaFinancialReport = sequelize.define("SshiaFinancialReport", {
...
}, { tableName: "sshia_financial_reports", modelName: "SshiaFinancialReport" });

module.exports = SshiaFinancialReport;
